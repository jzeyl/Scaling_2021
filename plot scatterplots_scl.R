...
runplot_HM_only<-function(e){
  ...
  ggplot(subset(longdfplotting,longdfplotting$earmeasures==yvarnames[e]), 
    ...
    geom_point(aes(shape = waterbirds), size = 2)+
   ...
   geom_line(data = subset(longdfplotting,longdfplotting$earmeasures==yvarnames[e]),
    ...
    geom_line(data = subset(longdfplotting,longdfplotting$earmeasures==yvarnames[e]),
              aes(x = log(Head.mass..g.),y = isoline), col = "green", size = 2)+
...
im<-ggarrange(
  ...
  runplot_HM_only(6),
  runplot_HM_only(7),
  runplot_HM_only(8), ncol = 2, nrow = 4)
im

other<-ggarrange(runplot_HM_only(9),
  #runplot_HM_only(10),
  runplot_HM_only(11),
  runplot_HM_only(12),
  runplot_HM_only(13)
